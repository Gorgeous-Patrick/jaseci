...
from jaclang.runtimelib.simulation.dpu_mem_layout import (
    get_all_memory_contexts,
    get_memory_context,
)
from jaclang.runtimelib.simulation.run_sim import (
    context_gen,
    get_node_types,
    uPIMulator,
    save_result_sum,
...
class JacPIM:
    ...
    def gen_walker_trace_graph(
        ...
        for idx, (from_node, to_node) in enumerate(edges):
            attr = graph.get_edge_data(from_node, to_node)
            if attr is None:
                attr = {"label": []}
