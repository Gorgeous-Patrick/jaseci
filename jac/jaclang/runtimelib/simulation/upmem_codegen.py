...
class FunctionDef(BaseModel):
    name: str
    body: str = Field(description="Function body as a string, do not include the function signature.")
    walker_type: TypeDef
    node_type: TypeDef
...
if __name__ == "__main__":
    context = CodeGenContext(
        ...
        run_ability_functions=[
            ...
            FunctionDef(name="run_ability_B", body="/* function body */", walker_type=TypeDef(name="WalkerTypeB", definition="/* walker type definition */"), node_type=TypeDef(name="NodeTypeB", definition="/* node type definition */")),
        ],
        walker_executions=[
            WalkerExecution(node_ptr=1, node_id=1, func=FunctionDef(name="run_ability_A", body="/* function body */", walker_type=TypeDef(name="WalkerTypeA", definition="/* walker type definition */"), node_type=TypeDef(name="NodeTypeA", definition="/* node type definition */"))),
            WalkerExecution(node_ptr=2, node_id=2, func=FunctionDef(name="run_ability_B", body="/* function body */", walker_type=TypeDef(name="WalkerTypeB", definition="/* walker type definition */"), node_type=TypeDef(name="NodeTypeB", definition="/* node type definition */"))),
        ]
    )
